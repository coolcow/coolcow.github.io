...
## About Me
{:.section-heading .section-icon-about}
...
### Interests & Mindset
{:.section-heading .section-icon-interests}
...
### Technical Skills
{:.section-heading .section-icon-technical}
...
<div class="coolcow-outro">
<pre class="moo-art"><code>          _( ~ )_
( moo! )   )O^O(
        ` ( @_@ )
           )   (</code></pre>
</div>